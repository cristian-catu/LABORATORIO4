...
void main(void) {
    ...
    if (PORTCbits.RC0 == 1){
        ...
        while(1){
            ...
            Lcd_Set_Cursor(2,1);
            sprintf(s, " %d%d:%d%d:%d%d  %d.%d%dV ", hours/10 ,hours%10, minutes/10, minutes%10, seconds/10, seconds%10, init_POT_0, dec_POT_0/10, dec_POT_0%10);
            Lcd_Set_Cursor(2,1);
